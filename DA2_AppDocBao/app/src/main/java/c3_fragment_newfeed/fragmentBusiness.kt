...
import com.example.da2_appdocbao.databinding.FragmentBusinessBinding
 ...
 */
class fragmentBusiness : Fragment(R.layout.fragment_business) {
    ...
    val url = "https://dantri.com.vn/rss/kinh-doanh.rss"
    ...
    private fun show_allfeeds(){
        viewLifecycleOwner.lifecycleScope.launch (Dispatchers.Main) {
            ...
            withContext(Dispatchers.Main) {
                if(isAdded) { // kiểm tra xem fragment có đc gắn vào activity k
                    if(rssFeed != null) {
