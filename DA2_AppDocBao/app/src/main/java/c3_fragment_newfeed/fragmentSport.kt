 ...
 * Use the [fragmentSport.newInstance] factory method to
 * create an instance of this fragment.
 */
class fragmentSport : Fragment(R.layout.fragment_sport) {
    private lateinit var binding: FragmentSocialBinding
    private lateinit var listNewFeeds: List<ItemFeed> // list 10 tin mới nhất
    private lateinit var adapterNewFeeds: adapterNewFeeds // adpater 10 tin mới
    private lateinit var rssFetcher: RssFetcher

    private lateinit var listAllFeeds: List<ItemFeed> // list toàn bộ tin
    private lateinit var adapterAllFeeds : adapterAllFeeds // adapter toàn bộ tin

    val url = "https://dantri.com.vn/rss/the-thao.rss"
